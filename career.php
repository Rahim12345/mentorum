...
if(isset($_GET['page']) && htmlspecialchars(trim($_GET['page']))=='career')
...
<div class="container" style="margin-top: 63px;">
    ...
    <nav aria-label="breadcrumb fixed-top">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Xaricdə Mən</li>
    ...
    <div class="row">
        ...
        ?>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body bg-info" style="margin-bottom: 10px;border-bottom-left-radius:10px;border-bottom-right-radius:10px;">

                        <span style="color:white;font-weight:1000;">Paylaş:</span>

                        <a href="#" style="color:white" onclick="share_fb('<?php echo $row['link']; ?>');return false;" rel="nofollow" share_url="http://urlhere.com/test/55d7258b61707022e3050000" target="_blank">

                            <img src="<?= $domain ?>assets/icons/facebook.png" style="width: 54px;" alt="">
                        ...
                        <a class="btn btn-default icon" href="javascript:void(0)" onclick="window.open( 'http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $row['link']; ?>', 'sharer', 'toolbar=0, status=0, width=626, height=436');return false;" target="_blank" title="Linkedin">
                            ...
                            <img src="<?= $domain ?>assets/icons/linkedin.png" style="width: 35px;" alt="">
