...
if (isset($_GET['page']) && htmlspecialchars(trim($_GET['page'])) == 'edit' && !empty($_GET['page']) && isset($_SESSION["id"])) {
...
?>
   ...
   ========================================================================== */
        ...
        <img align="left" class="fb-image-lg" src="./assets/profileBanner/cover.svg" style="height: 20vw" alt="Profile image" />
            ...
            <img align="left" style="border-radius: 50%;" class="fb-image-profile thumbnail" src="assets/profiles/<?php if(mb_strlen($rows[0]["image"])!=0){ echo $rows[0]["image"]; }else{ echo 'user.png'; } ?>" alt="Profile image" />

            <button class="btn btn-danger float-right" data-target="#editProfile" data-toggle="modal">Hesabı düzənlə <i class="fa fa-cog" aria-hidden="true"></i></button>
        ...
        <div class="row" style="margin-top:100px">
            ...
            <div style="width: 25%;">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link active" id="v-pills-about-tab" data-toggle="pill" href="#v-pills-about" role="tab" aria-controls="v-pills-about" aria-selected="true">Haqqımda</a>
