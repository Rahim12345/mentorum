function myPractice() {
    var x = document.getElementById("practicePhoto");
    var ext=[];
    var allowExt=["jpeg/jfif","jpeg 2000","exif","tiff","gif","bmp","png","webp","jpeg","jpg","psd"];
    if(x.files.length>1)
    {
      document.getElementById("error").innerHTML="";
      document.getElementById("error").innerHTML += "Maksimum şəkil sayı 1";
    }
    else
    {
      ...
      else
      {
        ...
        {
          document.getElementById("error").innerHTML="";
          document.getElementById("error").innerHTML += "Yalnız şəkil faylı əlavə edə bilərsiniz.";
        }
        else
        {
          document.getElementById("error").innerHTML="";
